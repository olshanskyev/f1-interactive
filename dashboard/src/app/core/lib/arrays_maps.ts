...
export function calculateSequenceChanges<V>(oldPositions: Map<string, V>, newPositions: Map<string, V>) {
...
export function convertObjectIntoSortedArray<V>(object: {[key: number | string]: V}): V[] {
    return Object.entries(object).sort(([a, ],[b, ]) => (+a) - (+b)).map(value => value[1]);
}

export function getLastNummericItem<V>(object: {[key: number | string]: V}): V {
