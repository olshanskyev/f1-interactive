...
@Component({
  ...
  template: `
    <ul class="f-s-12">
      <li>
         <a href="https://github.com/olshanskyev/f1-interactive" class="image-link">
          <svg viewBox="0 0 16 16" class="github-image fixed-image-size">
            <path
              fill="currentColor"
          ...
          <span class="link-text text-nowrap">GitHub</span>
        </a>

      </li>
      <li>
        <a href="https://buymeacoffee.com/olshanskyev" class="image-link">
          <img src="/images/bmc-logo.svg" alt="Buy me a coffee" class="buy-coffee-image fixed-image-size"/>
